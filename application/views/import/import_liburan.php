<link rel="stylesheet" href="<?=base_url()?>/assets/styles/bootstrap.css" />
	...
	<div class="panel-heading">Import Data Hari Libur Kerja</div>
		<div class="panel-body">
			<form name="myForm" id="myForm" action="<?=site_url()?>LiburController/go_import" method="post" enctype="multipart/form-data">
