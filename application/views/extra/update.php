<div class="col-md-12">
	<h4>Halaman Update Jam Ekstra Karyawan</h4>
	<hr>
		<div class="row">
			<form action="" name="form1" id="form1" method="post">
					<div class="form-group col-md-6">
						...
						<input type="hidden" name="lama" value="<?=$data->lama_jam?>">
					</div>
					<div class="form-group col-md-6">
						<label>Jenis Ekstra</label>
						<input type="hidden" name="jenis_ekstra2" value="<?php echo $data->jenis_ekstra;?>">
						<select name="jenis_ekstra" id="jenis_ekstra" class="form-control" disabled>
							<option value="1" <?php if($data->jenis_ekstra==1) echo "selected"?>>Ekstra Kerja</option>
							<option value="2" <?php if($data->jenis_ekstra==2) echo "selected"?>>Ekstra Lain</option>
						</select>
					</div>
					<div class="col-md-12">
						<div class="row">
							<div id="lain">
								<div class="form-group col-md-12">
									...
									<input  name="nominal" class="form-control" type="text" value="<?=$data->jumlah_vakasi?>" data-mask="#.##0" data-mask-reverse="true" data-mask-maxlength="false"/>
								</div>
							</div>
							<div id="kerja">
								<div class="form-group col-md-3">
									<label>Jam Mulai</label>
									<input class="form-control" type="text" name="jam1" id="jam1" value="<?=$data->jam_mulai?>" data-mask="00:00:00" data-mask-reverse="true" data-mask-maxlength="true"/>
								</div>
								<div class="form-group col-md-3">
									<label>Jam Selesai</label>
									<input class="form-control" type="text" name="jam2" id="jam2" value="<?=$data->jam_finish?>" data-mask="00:00:00" data-mask-reverse="true" data-mask-maxlength="true"/>
								</div>
								<div class="form-group col-md-6" id="div_vakasi">
									<label>Vakasi</label>
									<select name="vakasi" id="vakasi" onchange="jenis()" class="form-control">
										<option selected><?=$data->vakasi?></option>
										<option value="Tambah DP Libur">Tambah DP Libur</option>
										<option value="Dibayar">Dibayar</option>
									</select>
								</div>
								<div class="form-group col-md-3" id="uang" hidden>
									<label>Tarif Upah Per Jam</label>
									<input class="form-control" type="text" name="upah" id="upah" value="<?=$data->jumlah_vakasi/$data->lama_jam?>" data-mask="#.##0" data-mask-reverse="true" data-mask-maxlength="false"/>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="form-group col-md-4">
						...
						<input type="text" name="tanggal_ekstra" value="<?=$data->tanggal_ekstra?>" id="date-picker2" readonly class="form-control" />
					</div>
					<div class="form-group col-md-12">
...
$(function() {
	...
	function jenis(){
	 	...
	 	if (vee == "Dibayar") {
	 		...
	 		$('#div_vakasi').attr('class','form-group col-md-3');
	 	} else {
