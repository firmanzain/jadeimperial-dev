<div class="col-md-12">
	<h4>Halaman Input Master Data DP Karyawan</h4>
	<hr>
		<div class="row">
			<form action="" name="form1" id="form1" method="post">
					...
					<div class="form-group col-md-6">
						...
						<input type="number" name="saldo_dp" class="form-control">
					</div>
					<div class="form-group col-md-6">
						<label>Jumlah Cuti Tahunan</label>
						<input type="number" value="12" name="saldo_cuti" class="form-control">
					</div>
					<div class="form-group col-md-12">
